...
func defineClasse(name string, hp, mp, poder, forca, agilidade, level, xp int) *models.IPersonagem { //Retorna persoagem completo e define sua classe de acordo com a distribuição de pontos
	rand.Seed(time.Now().UnixNano())
	equilibriumx := 2
